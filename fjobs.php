        ...
        <div class="container">
          ...
          <div class="d-flex flex-row bd-highlight mb-4 justify-content-center apl-job-post">
            <div class="p-2 bd-highlight">
              <a href="fpost.php" class="btn btn-warning w-0" id="btn-post ">Post Job</a></div>
            <div></div>
              <div class="p-2 bd-highlight">
              <a href="#job" class="btn btn-warning w-0" id="btn-apply">Apply For Job</a></div>
          </div>
          ...
          ?>
            ...
            <div class="card bg-dark border-5 shadow-lg" id="card-down-margin">
              <div class="card-body">
                ...
                <a href="fapplyforjob.php" class="btn btn-warning">Apply For Job</a>
              </div>
            </div>
          <!-- Card End --> 
